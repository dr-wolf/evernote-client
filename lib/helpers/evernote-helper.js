...
exports.createNotebook = function(noteStore, name, callback) {
    ...
    return noteStore.createNotebook(notebook).then(function(notebook) {
        callback(chopObject(notebook, ["name", "guid"]));
    }).catch(errorHandler);
};

exports.getTags = function(noteStore, callback) {
    return noteStore.listTags().then(function(tags) {
        console.log(tags);
...
exports.createTag = function(noteStore, name, tagGuid, callback) {
    ...
    return noteStore.createTag(tag).then(function(tag) {
...
exports.getNotes = function(noteStore, notebookGuid, searchQuery, callback) {
    ...
    return noteStore.findNotesMetadata(filter, 0, 65535, {includeTitle: true, includeNotebookGuid: true}).then(function(notesMeta) {
...
exports.getNote = function(noteStore, noteGuid, callback) {
    return noteStore.getNote(noteGuid, true, false, false, false).then(function(note) {
...
exports.createNote = function(noteStore, title, body, notebookGuid, callback) {
    ...
    return noteStore.createNote(note).then(function(note) {
